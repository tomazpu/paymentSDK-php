...
// Since the Maestro data needs to be sent directly to Wirecard, you need to invoke the creation of a special form
// for entering the Maestro data. This form is created via a javascript. Additional processing also needs
// to take place on the client-side, so that the Maestro data is not processed and/or stored anywhere else.
...
<div class="container">
    ...
    <form id="payment-form" method="post" action="reserve.php">
        <?php
        // The token ID, which is returned from the Maestro UI, needs to be sent on submitting the form.
        ...
        // The javascript library needs a div which it can fill with all Maestro related fields.
        ?>
...
<script type="application/javascript">
    ...
    // To prevent the data to be submitted on any other server than the Wirecard server, the Maestro UI form
    ...
    function submit(event) {
        ...
        if ($('#tokenId').val() == '') {
            ...
            // If not, we will prevent the submission of the form and submit the form of Maestro UI instead.
